# Guild wars team builder features

This document contains features that we would **LIKE** to see in this application.
...
| Emoji | Meaning                                    | 
|----|--------------------------------------------|
| ✅ | Completed and should go out with a release |
| 👀 | In progress work                           | 
| 💭| Will be done, but not committed yet        |
